...
You should also have a mild understanding of Shopify's [theme settings](https://help.shopify.com/en/manual/online-store/legacy/using-themes/change-the-layout/theme-settings), [Liquid template language](https://shopify.github.io/liquid/), [AJAX API](https://shopify.dev/docs/themes/ajax-api), and are familiar with the [git workflow](https://www.atlassian.com/git/tutorials/comparing-workflows/gitflow-workflow).
...
- There is a new "Collection" section in the Shopify customize view, under "Theme settings"
...
- There is a second toggle to change the button to "add to cart"
